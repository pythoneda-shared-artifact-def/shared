...
{
  description = "Nix flake for pythoneda-shared-artifact/shared";
  inputs = rec {
    ...
    pythoneda-shared-artifact-events = {
      ...
      url = "github:pythoneda-shared-artifact-def/events/0.0.96";
    };
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "shared";
        version = "0.0.16";
        sha256 = "1xhaahgmb676m1cdfq55plnnixbdqlgp7ipiza80g0s3wyzsbphn";
        pname = "${org}-${repo}";
      ...
      in rec {
        ...
        devShells = rec {
          default = pythoneda-shared-artifact-shared-python312;
          ...
          pythoneda-shared-artifact-shared-python313 = shared.devShell-for {
            banner = "${
                pythoneda-shared-pythonlang-banner.packages.${system}.pythoneda-shared-pythonlang-banner-python313
              }/bin/banner.sh";
            extra-namespaces = "";
            nixpkgs-release = nixpkgsRelease;
            package = packages.pythoneda-shared-artifact-shared-python313;
        ...
        packages = rec {
          ...
          pythoneda-shared-artifact-shared-python313 =
            pythoneda-shared-artifact-shared-for {
              python = pkgs.python313;
              pythoneda-shared-artifact-events =
