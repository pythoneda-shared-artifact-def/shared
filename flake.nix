...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-shared-artifact-events = {
      ...
      url = "github:pythoneda-shared-artifact-def/events/0.0.12";
    };
    pythoneda-shared-git-shared = {
      ...
      inputs.pythoneda-shared-pythoneda-domain.follows =
        "pythoneda-shared-pythoneda-domain";
      url = "github:pythoneda-shared-git-def/shared/0.0.12";
    };
    pythoneda-shared-nix-flake-shared = {
      ...
      inputs.pythoneda-shared-pythoneda-domain.follows =
        "pythoneda-shared-pythoneda-domain";
      url = "github:pythoneda-shared-nix-flake-def/shared/0.0.13";
    };
    pythoneda-shared-pythoneda-banner = {
      inputs.flake-utils.follows = "flake-utils";
      inputs.nixos.follows = "nixos";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "shared";
        version = "0.0.7";
        sha256 = "0ydsdcmny9xbd5a6xlhnsi1lrgl5q074g302cakcnl7vxs61vl2d";
        pname = "${org}-${repo}";
